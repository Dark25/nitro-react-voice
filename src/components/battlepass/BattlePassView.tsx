...
export const BattlePassView: FC<{}> = props =>
{
    ...
    function buyBattlePass(){
        fetch("https://int.hgalaxy.fun/?type=buyGalaxyPass&sso=" + sso);
        setIsVisible(false);
    }
    ...
    function getHabboImaging(look){
        return "https://habbo-imaging.hgalaxy.net/avatarimage/" + look + "&gesture=sml&direction=2&effect=3&size=l&img_format=gif";
    }
            ...
            linkReceived: (url: string) =>
            {
                ...
                switch(parts[1])
                {
                    case 'open':
                        ...
                        fetch("https://int.hgalaxy.fun/?type=getInfoOpenGalaxyPassEmu&sso=" + sso)
    ...
    return (
        <>
            { isVisible &&
                <NitroCardView>
                <NitroCardHeaderView headerText="Galaxy Pass"  onCloseClick={ event => setIsVisible(false) }/>
