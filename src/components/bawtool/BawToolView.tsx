...
export const BawToolView: FC<{}> = props =>
{
    ...
    function maxFloor(){
        fetch("https://int.hgalaxy.fun/?type=maxFloor&sso="+sso);
    }

    function autoFloor(){
        fetch("https://int.hgalaxy.fun/?type=autoFloor&sso="+sso);
    }

    function reloadRoom(){
        fetch("https://int.hgalaxy.fun/?type=reloadRoom&sso="+sso);
    }

    function changeAltura(){
        fetch("https://int.hgalaxy.fun/?type=cambiarAltura&altura="+altura+"&sso="+sso);
    }

    function resetAltura(){
        fetch("https://int.hgalaxy.fun/?type=cambiarAltura&altura=999&sso="+sso);
    }

    function cambiarEstado(){
        fetch("https://int.hgalaxy.fun/?type=cambiarEstado&estado="+estado+"&sso="+sso);
    }

    function cambiarRotacion(){
        fetch("https://int.hgalaxy.fun/?type=cambiarRotacion&rotacion="+rotacion+"&sso="+sso);
    }
