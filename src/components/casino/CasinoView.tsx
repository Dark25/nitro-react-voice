...
export const CasinoView: FC<{}> = props =>
{
    ...
    function betDados(){
        fetch("https://int.hgalaxy.fun/?type=betDadosCasino&quantity=" + diceBet + "&coin=" + diceCoin + "&number=" + diceNumber + "&sso="+sso);

        setIsVisible(false);
    }

    function betRuletaSuelo(){
        fetch("https://int.hgalaxy.fun/?type=betRuletaSuelo&quantity=" + ruletaSueloBet + "&coin=" + ruletaSueloCoin + "&number=" + ruletaSueloNumber + "&sso="+sso);

        setIsVisible(false);
    }

    function betRuletaPared(){
        fetch("https://int.hgalaxy.fun/?type=betRuletaPared&quantity=" + ruletaParedBet + "&coin=" + ruletaParedCoin + "&sso="+sso);
