        ...
        <NitroCardView className="nitro-friends-messenger animate__animated animate__bounceInDown animate__faster" uniqueKey="nitro-friends-messenger" theme="primary-slim">
            ...
            <NitroCardContentView>
                <Grid overflow="hidden">
                    <Column size={ 4 }>
                        <Text style={{color: "var(--test-galaxytext)"}} variant="none"  bold>{ LocalizeText('toolbar.icon.label.messenger') }</Text>
                    ...
                    <Column size={ 8 } overflow="hidden">
                        { activeThread &&
                            <>
                                <Text style={{color: "var(--test-galaxytext)"}} variant="none"  bold center>{ LocalizeText('messenger.window.separator', [ 'FRIEND_NAME' ], [ activeThread.participant.name ]) }</Text>
