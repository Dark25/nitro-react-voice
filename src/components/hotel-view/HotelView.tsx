...
export const HotelView: FC<{}> = props =>
{
    ...
    useEffect(() => {
        fetch("https://int.hgalaxy.fun/?type=getHotelViewStats&sso=" + sso)
    ...
    function getImagerByFigure(figure) { return "url(https://habbo-imaging.hgalaxy.net/avatarimage/" + figure + "&amp;direction=2&amp;head_direction=2)"; } 

    function getProfileUrl(username) { return "https://hgalaxy.net/community/profile?user=" + username; }
