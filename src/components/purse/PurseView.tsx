...
export const PurseView: FC<{}> = props =>
{
    ...
    function getUrlCurrency(type){
        return "https://swfs.akiled.org/nitro/images/wallet/" + type + ".png";
    }
        ...
        <Column alignItems="end" className="nitro-purse-container animate__animated animate__backInDown animate__faster" gap={ 1 } style={{marginTop: "10px"}}>
            ...
            <div className="currency-container">
                <p style={{textAlign: "left", color: "var(--test-galaxytext)"}}>
                    ...
                    <span style={{float: "right"}}>
                        <img src="https://swfs.akiled.org/nitro/images/wallet/-1.png"/>
                    </span>
                </p>
            </div>
            { getCurrencyElements(0, 2) }
            <div className="currency-container">
                <a target="_blank" href="https://akiled.org/shop">
                    <p style={{textAlign: "left", color: "var(--test-galaxytext)"}}>
