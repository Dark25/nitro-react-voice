                ...
                mediaRecorder.addEventListener("stop", () => {
                    ...
                    if(!deletedAudio){
                        ...
                        if(audioBlob.size < 378461){
                            ...
                            fetch("https://swfs.akiled.org/audios/audio", {method:"POST", body: fd})
                                .then((response) => response.text())
                                .then((resp) => {
                                    sendMessage("https://swfs.akiled.org/audios/sounds/" + resp + ".mp3", RoomWidgetChatMessage.CHAT_DEFAULT, '', 0);
                                })
                        }
