...
export const UpsideView: FC<{}> = props =>
{
    ...
    function sendResponse(username, identifier){
        fetch("https://int.hgalaxy.fun/?type=mentionUser&userToMention=" + username + "&message=" + response + "&sso=" + sso);
        ...
        <>
            { isVisible &&
                ...
                <div className="nitro-left-side animate__animated animate__backInDown">
                    <a href="https://hgalaxy.net" target="_blank" className="nitro-left-side-button btn btn-sm rounded-pill border border-light">
                        <img src="https://swfs.hgalaxy.net/images/casa.png"style={{marginTop: "2px", marginBottom: "2px"}}/> Web
                    </a>
                    <button onClick={ event => CreateLinkEvent('help/show') } style={{backgroundColor: "var(--test-galaxytwo)", marginLeft: "7px"}} className="btn btn-sm rounded-pill border border-light nitro-left-side-button">
                        <img src="https://swfs.hgalaxy.net/images/frank.gif" style={{marginTop: "2px", marginBottom: "2px"}} /> Ayuda
                    </button>
                    <button style={{backgroundColor: "var(--test-galaxytwo)", marginLeft: "7px"}} className="btn btn-sm rounded-pill border border-light nitro-left-side-button">
                        <img style={{transform: "scale(0.9)"}} src="https://swfs.hgalaxy.net/images/ons.png"/><b id="usersOnline">0</b> &nbsp;
                    </button>
                    <button style={{backgroundColor: "var(--test-galaxytwo)", marginLeft: "7px"}} className="btn btn-sm rounded-pill border border-light nitro-left-side-button">
