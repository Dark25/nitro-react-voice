...
export const WelcomeWizardView : FC<{}> = props =>
{
    ...
    function changeLook(look){
        switch(look){
            case 1:
                fetch("https://hgalaxy.net/system/controllers/eha.php?changeLook=ch-215-1189.sh-305-92.hr-851-45.ea-987463055-62-62.hd-209-2.lg-710-82.wa-2007-1408.ca-3175-1408&sso=" + sso);
                break;

            case 2:
                fetch("https://hgalaxy.net/system/controllers/eha.php?changeLook=hr-515-45.hd-629-2.ch-255-91.lg-710-1409.sh-906-80.he-1603-80&sso=" + sso);
                break;

            case 3:
                fetch("https://hgalaxy.net/system/controllers/eha.php?changeLook=hr-989999875-1092.hd-629-2.ch-665-64.lg-3174-1195-1408.sh-305-92.he-1606-1408.ca-1807-1408&sso=" + sso);
                break;

            case 4:
                fetch("https://hgalaxy.net/system/controllers/eha.php?changeLook=ch-250-64.sh-3016-110.hr-828-1028.ea-987463055-62-62.hd-180-1006.lg-3078-110.he-3071-92&sso=" + sso);
                break;
        }
    ...
    function chooseWelcomeRoom(room){
        fetch("https://hgalaxy.net/system/controllers/eha.php?chooseWelcomeRoom=" + room + "&sso=" + sso);
        setCurrentTab("furni")
    }
    ...
    return (
        <>
            { isVisible &&
                <NitroCardView>
                <NitroCardHeaderView headerText="Bienvenid@ a HGalaxy"  onCloseClick={ event => setIsVisible(false) }/>
                <NitroCardContentView className="text-dark">
                    <Tabs defaultActiveKey="home" id="uncontrolled-tab-example" className="mb-3" activeKey={currentTab}>
                                    ...
                                    <div className="alert bg-warning">
                                        <div style={{textAlign: "left"}}>
                                            ...
                                            <span style={{float: "right"}}>
                                                <a href="https://hgalaxy.net/logout"><span className="badge bg-success">Iniciar sesión</span></a>
                                            </span>
                                        </div>
                                    </div>
                                </Col>
                                <Col md={7} style={{color: "var(--test-galaxytext)"}}>
                                    <h4 style={{color: "var(--test-galaxytext)"}}><b>¡Nos complace darte la bienvenida a HGalaxy!</b></h4>
                            ...
                            <div className="container">
                                <Row>
                                    <Col md={3}>
                                        <div className="text-white look-image card" style={{ backgroundImage: "url(https://files.habboemotion.com/resources/images/homebgs/ruled_paper.gif)" }}>
                                            <div className="card-body">
                                                <img className="mx-auto d-block" src="https://habbo-imaging.hgalaxy.net/avatarimage/ch-215-1189.sh-305-92.hr-851-45.ea-987463055-62-62.hd-209-2.lg-710-82.wa-2007-1408.ca-3175-1408&gesture=sml&action=wav&direction=3" />
                                                <br/>
                                    ...
                                    <Col md={3}>
                                        <div className="text-white look-image card" style={{ backgroundImage: "url(https://files.habboemotion.com/resources/images/homebgs/ruled_paper.gif)" }}>
                                            <div className="card-body">
                                                <img className="mx-auto d-block" src="https://habbo-imaging.hgalaxy.net/avatarimage/hr-515-45.hd-629-2.ch-255-91.lg-710-1409.sh-906-80.he-1603-80&gesture=sml&action=wav&direction=3" />
                                                <br/>
                                    ...
                                    <Col md={3}>
                                        <div className="text-white look-image card" style={{ backgroundImage: "url(https://files.habboemotion.com/resources/images/homebgs/ruled_paper.gif)" }}>
                                            <div className="card-body">
                                                <img className="mx-auto d-block" src="https://habbo-imaging.hgalaxy.net/avatarimage/hr-989999875-1092.hd-629-2.ch-665-64.lg-3174-1195-1408.sh-305-92.he-1606-1408.ca-1807-1408&gesture=sml&action=wav&direction=3" />
                                                <br/>
                                    ...
                                    <Col md={3}>
                                        <div className="text-white look-image card" style={{ backgroundImage: "url(https://files.habboemotion.com/resources/images/homebgs/ruled_paper.gif)" }}>
                                            <div className="card-body">
                                                <img className="mx-auto d-block" src="https://habbo-imaging.hgalaxy.net/avatarimage/ch-250-64.sh-3016-110.hr-828-1028.ea-987463055-62-62.hd-180-1006.lg-3078-110.he-3071-92&gesture=sml&action=wav&direction=3" />
                                                <br/>
                        ...
                        <Tab eventKey="security" title="Seguridad">
                            ...
                            <a href="https://akiled.org/me/settings" onClick={e => setIsVisible(false)} target="_blank" className="btn btn-primary w-100">Crear nueva contraseña</a>
